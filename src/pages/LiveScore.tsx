...
const LiveScoreContent = () => {
  ...
  >([
    {
      user: "CricketFan01",
      text: "What a magnificent six by Singh!",
      time: "3 min ago",
    },
    {
      user: "BowlingExpert",
      text: "Kumar is in great form today",
      time: "5 min ago",
    },
    {
      user: "StatGuru",
      text: "That's the 5th boundary in this over!",
      time: "7 min ago",
    },
  ]);
          ...
          <section className="py-16">
            <div className="container mx-auto px-4 text-center">
              ...
              <p className="text-gray-600 max-w-lg mx-auto mb-6">
                There are no matches being played at the moment. Check back
                later or view upcoming matches.
              </p>
              <a
                href="/schedule"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4 max-h-96 overflow-y-auto mb-4">
                    <div className="p-3 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-blue-900">
                        FOUR! Beautiful cover drive by Singh, finds the gap
                        perfectly!
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-blue-900">
                        Kumar comes in to bowl his 4th over. He's been excellent
                        today with figures of 2-28 so far.
                      </p>
                    </div>
              ...
              <div className="space-y-6">
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
                  <h3 className="text-lg font-semibold mb-4 flex items-center">
                    <Users size={20} className="mr-2 text-blue-600" /> Match
                    Info
                  </h3>
                  ...
                  <div className="space-y-3">
                    ...
                    {currentMatch.tossWinner && (
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {getTeamById(currentMatch.tossWinner)?.name} (
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {Math.round(
                            (liveScore.totalRuns / liveScore.overs) * 20
                          )}
                          -{liveScore.wickets + 2}
                        </span>
                      </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Prediction based on current match situation, team form,
                ...
                <div className="bg-red-50 border border-red-100 rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm text-red-800">
                    ...
                    <p>
                      • Titans bring on their star bowler for a crucial spell
                    </p>
